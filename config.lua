...
Config = {
	...
	Target = false, --If true will use target, if false will use Interact
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 0, amount = 100},
			{ name = "sandwich", price = 0, amount = 250 },
			{ name = "bandage", price = 0, amount = 100},
			{ name = "weapon_flashlight", price = 0, amount = 100 },
			{ name = "goldpan", price = 0, amount = 100},
			{ name = "pickaxe",	price = 100, amount = 100},
			{ name = "miningdrill",	price = 10000, amount = 50},
			{ name = "mininglaser",	price = 60000, amount = 5},
			{ name = "drillbit", price = 0, amount = 100},
		},
	},
}
Crafting = {
